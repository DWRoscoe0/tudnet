...
public class ViewHelper
  ...
  { // class ViewHelper
    ...
    /* Location/Selection-related variables.
      ...
      */
      ...
      private TreePath SelectedChildTreePath; /* TreePath of the selected item.
        It it one of possibley multiple items being displayed by 
      ...
      public void NotifyTreeSelectionListenersV( boolean InternalB )
        /* Notifies any TreeSelectionListeners of the JComponent being helped
          ...
          InternalB has the following meanings:
            ...
            false: the selection must be handled by 
    ...
    // output methods.
      ...
      public Object xGetSelectedObject()  // this method is unused ???
        /* This method returns the Object representing the selected position. */
        { 
          return   // return last Object in selected TreePath.
            SelectedChildTreePath.getLastPathComponent();
          }
