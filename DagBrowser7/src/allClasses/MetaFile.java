  ...
  { // class MetaFile.
    ...
    private static MetaNode readFlatStateMetaNode( )
        ...
        */
      {
        ...
        MetaNode RootMetaNode=   // Do the actual read.
          theMetaFile.readAllStateMetaNode( );
    ...
    private static MetaNode readHierarchicalStateMetaNode( )
        ...
        */
      {
        MetaFile theMetaFile= new MetaFile();
        // Set some appropriate mode variables.
        theMetaFile.TheRwStructure= RwStructure.HIERARCHICAL;
        theMetaFile.FileNameString= HierarchicalFileNameString;
        theMetaFile.HeaderTokenString= HierarchicalHeaderTokenString;
        MetaNode RootMetaNode=   // Do the actual read.
          theMetaFile.readAllStateMetaNode( );
    ...
    private MetaNode readAllStateMetaNode( )
      /* Read all MetaNodes, or at least the root one, from this MetaFile.  
    ...
    private static void writeFlat( )
      /* Writes all MetaNodes to Flat file.  */
      {
        ...
        theMetaFile.FileNameString= FlatFileNameString;
        theMetaFile.HeaderTokenString= FlatHeaderTokenString;
        theMetaFile.writeAllState(   // Do the actual write.
    ...
    public static void writeDebugState( MetaNode InMetaNode )
      /* Writes all MetaNodes in Hierarchical format to Debug file.  */
      {
        ...
        theMetaFile.writeAllState( InMetaNode );  // Do the actual write.
        }

    private void writeAllState( MetaNode inRootMetaNode )
    ...
    private MetaNode rwAllStateMetaNode( MetaNode inRootMetaNode )
      throws IOException
    ...
    public IDNumber rwConvertIDNumber
        ...
        */
      {
        ...
        while (true) { // Search state file for desired MetaNode.
          try {
            ...
            resultIDNumber= MetaNode.rwFlatMetaNode( 
              this,
              null, 
              parentDataNode 
              );
